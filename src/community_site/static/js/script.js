...
function getHome() {
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="static/img/img-1.jpg" alt="">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="static/img/img-2.jpg" alt="">
      <div class="carousel-caption">
                       <h1 class="display-3">Opendev</h1>
                       <h4>An Open Source Community</h4>
                       <a href="https://discord.gg/Zp3sKp" class="btn btn-outline-light btn-lg">Join Now</a>
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="static/img/img-3.jpeg" alt="">
      <div class="carousel-caption">
                       <h1 class="display-3">Opendev</h1>
                       <h4>An Open Source Community</h4>
                       <a href="https://discord.gg/Zp3sKp" class="btn btn-outline-light btn-lg">Join Now</a>
